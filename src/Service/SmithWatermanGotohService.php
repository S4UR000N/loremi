...
// src/Service/SmithWatermanGotohService.php
namespace App\Service;

use App\Service\SmithWatermanMatchMismatchService;

class SmithWatermanGotohService
{
    private $gapValue;
                ...
                $substitution=null)
    {
        ...
        if (empty($substitution)) $this->substitution = new SmithWatermanMatchMismatchService(1.0, -2.0);
